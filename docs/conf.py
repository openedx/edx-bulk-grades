...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/edx-bulk-grades",
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Support for bulk scoring and grading',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'bulk_grades'),
                os.path.join(root_path, 'bulk_grades/migrations')])
